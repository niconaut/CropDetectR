...
Using the Otsu method of image thresholding we are able to capture only the plant material as white (value of 1) and the rest of the non-organic material is black (value of 0). This will be very benficial for the next steps because a binary image is needed. For more on how the Otsu transformation works check out (...) and (...).
